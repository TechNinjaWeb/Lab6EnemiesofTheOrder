...
' Database Code Generated on 3/28/2017 6:00:06 PM by Al Jarrah &Thompson
Namespace DBL
...
#Region " -- Constructors -- "
            Public Sub New(allianceID_ As Integer, allianceName_ As String, isActive_ As String)
...
#Region " -- Constructors -- "
            Public Sub New(enemyID_ As Integer, firstName_ As String, lastName_ As String, threatLevelID_ As Integer, notes_ As String, allianceID_ As Integer, allianceName_ As String, isActive_ As Boolean)
...
#Region "-- Generic Methods --"
            ...
            Public Shared Function test(EnemyID As Integer)
                Dim RetVal As New DBL.Views.Enemies
                Dim T As New DBL.Tables.datEnemy
                T = DBL.Tables.datEnemy.getOneRow(EnemyID)
